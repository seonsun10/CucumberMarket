				...
				<form action="" method="post">
					<div class="row">
						...
						<div class="form-group">
	                        ...
	                        <input id="inquiryId" type="text" value="${Member.userId }" class="form-control">
                      	</div>	
					...
					<div class="col-md-12">
                      ...
                      <button type="button" class="btn btn-primary" onclick="location.assign('${pageContext.request.contextPath }/inquiryView')">취소</button>
                    </div>
                  </div>
                  <!-- /.row-->
                </form>
