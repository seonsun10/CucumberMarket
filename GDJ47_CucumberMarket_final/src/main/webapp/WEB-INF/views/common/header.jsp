              ...
              <div id="search-not-mobile" class="navbar-collapse collapse">
                 <a href="${path }/faqList" class="btn btn-primary navbar-btn"> FAQ</a>
					...
					<c:when test="${ loginMember != null}">
	              		...
	              		<div id="search-not-mobile" class="navbar-collapse collapse" >
				  			<a class="nav-link py-0"  data-toggle="modal"  data-target="#chatModal" >
      					...
      					<div id="search-not-mobile" class="navbar-collapse collapse" >
		       				<a class="nav-link py-0" data-toggle="modal" data-target="#alertModal">
...
<div class="modal fade" id="chatModal"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="exampleModalLabel">&lt;안읽은 채팅&gt;</h4>
				</div>
...
/* function fn_area(){
     window.open(
      ...
      "width=800, height=600, top=100, left=600"
		...
		$('#alertModalBody').load("${path }/member/notify.do");
		$('#chatModalBody').load("${path }/member/chat.do");
